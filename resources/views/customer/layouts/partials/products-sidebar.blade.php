<aside id="sidebar" class="sidebar col-md-3">
    ...
    <section class="content-wrapper bg-white p-3 rounded-2 mb-3">
        ...
        <form action="{{ route('customer.products', request()->category ? $category->id : null) }}" method="get">
            <input type="hidden" name="sort" value="{{request()->sort}}" />

            <!-- start sidebar nav-->
            <section class="sidebar-nav">
                <h2 class="content-header-title content-header-title-small border-bottom pb-2">
                    دسته بندی های کالا
                </h2>
    ...
    <section class="content-wrapper bg-white p-3 rounded-2 mb-3">
        <section class="sidebar-filter-btn d-grid gap-2 mt-3 mb-2">
            <button class="btn btn-danger" type="submit">اعمال فیلتر ها</button>
