...
@section('title','ویرایش تخفیف عمومی')
                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="percentage" class="form-control form-control-sm" value="{{old('percentage', $commonDiscount->percentage)}}">
                            </div>
                            @error('percentage')
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="">حداقل مبلغ خرید(تومان)</label>
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group">
                                ...
                                <select name="status" id="status" class="form-control form-control-sm">
                                    <option value="0" @if($commonDiscount->status ==0) {{'selected'}} @endif>غیر فعال</option>
                                    <option value="1" @if($commonDiscount->status ==1) {{'selected'}} @endif>فعال</option>
                                </select>
                            </div>
                            @error('status')
                            <span class="text-white bg-danger rounded">
