...
<section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section>
                <form action="{{route('admin.market.brand.update', $brand->id)}}" id="form" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <section class="row">
                    ...
                    <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="persian_name" value="{{$brand->persian_name}}">
                            </div>
                            @error('persian_name')
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="orginal_name" value="{{$brand->orginal_name}}">
                            </div>
                            @error('orginal_name')
                            <span class="text-white bg-danger rounded">
                                {{$message}}
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group">
                                ...
                                <select name="status" id="status" class="form-control form-control-sm">
                                    <option value="0" @if($brand->status == 0) {{'selected'}} @endif>غیر فعال</option>
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group">
                                ...
                                <input id="tags" name="tags" type="hidden" class="form-control form-control-sm" value="{{$brand->tags}}">
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group">
                                ...
                                <section>
                                    ...
                                    <img src="{{asset($brand->logo)}}" class="mt-2" width="150px" height="150px" alt="تصویر ندارد"/>
