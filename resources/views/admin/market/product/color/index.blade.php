    ...
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section class="d-flex justify-content-between align-items-center border-bottom mt-4 mb-3 pb-2">
                ...
                <a href="{{route('admin.market.product.color.create' , $product->id)}}" class="btn btn-primary btn-sm">ایجاد رنگ جدید</a>
                </section>
                ...
                <table class="table table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center width-16-rem">رنگ کالا</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{number_format($color->price_increase)}} تومان</td>

                            <td class="text-center">
                                <form action="{{route('admin.market.product.color.destroy', ['product'=>$product->id, 'productColor'=>$color->id])}}" method="post" class="d-inline">
                                    @csrf
                                    @method('delete')
